...
Other: Input any path"
    ...
    sudo wget -O $INSTALL_PATH/gir https://github.com/Icycoide/Gir/releases/download/v0.2.7.1/main.sh || failure "Either failed download or invalid path or sudo does not exist."
